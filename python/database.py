...
class Database:
    def selectAllUsers(self) -> list:
        with open("./python/database/users.json", "r", encoding="utf-8") as file:
            data = file.read()
    ...
    def register (self, name: str, surname: str, username: str, password: str):
        ...
        with open("./python/database/users.json", "w") as file:
    ...
    def selectAllPosts(self) -> list:
        with open("./python/database/posts.json", "r", encoding="utf-8") as file:
            data = file.read()
    ...
    def addPost(self, user_id: int, post_text: str) -> None:
        ...
        with open("./python/database/posts.json", "w") as file:
